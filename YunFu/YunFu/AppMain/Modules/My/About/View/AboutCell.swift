...
final class AboutCell: UITableViewCell {
    ...
    private func setupUI() {
        ...
        NSLayoutConstraint.activate([
            ...
            container.topAnchor.constraint(equalTo: tapView.topAnchor, constant: 6),
            container.bottomAnchor.constraint(equalTo: tapView.bottomAnchor, constant: -6)
        ])
        ...
        NSLayoutConstraint.activate([
            ...
            leftIcon.leadingAnchor.constraint(equalTo: container.leadingAnchor),
            ...
            titleLabel.trailingAnchor.constraint(lessThanOrEqualTo: rightIcon.leadingAnchor, constant: -10),
